...
def upgrade() -> None:
    ...
    # 2. Create Users first (independent of Characters for initial creation)
    ...
    # 3. Create Characters (referencing Users)
    ...
    # 4. Add the circular FK to Users
    op.create_foreign_key('fk_users_active_character_id', 'users', 'characters', ['active_character_id'], ['id'])
