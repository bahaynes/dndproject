...
Revision ID: 43d88e4142dc
Revises: 27a63fa02a52
Create Date: 2026-02-08 12:49:43.322077
...
revision: str = '43d88e4142dc'
down_revision: Union[str, None] = '27a63fa02a52'
...
def upgrade() -> None:
    ...
    # owner_id FK added later to avoid circular dependency
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_foreign_key('fk_characters_owner_id', 'characters', 'users', ['owner_id'], ['id'])
