...
<div class="container mx-auto p-4">
	...
	{#if showCreateForm}
		<div class="card bg-base-200 my-4 p-4 shadow-xl">
			<h2 class="mb-2 text-xl font-bold">New Session</h2>
			<form on:submit|preventDefault={createSession}>
				...
				<div class="form-control">
					...
					<input
						type="datetime-local"
						id="session_date"
						bind:value={newSession.session_date}
						class="input input-bordered"
						required
					/>
				</div>
							...
							<form on:submit|preventDefault={() => updateSession(session.id)}>
								<div class="form-control">
									...
									<select
										...
										bind:value={sessionToUpdate.status}
								...
								<div class="form-control mt-2">
									...
									<textarea
										id="aar-{session.id}"
										bind:value={sessionToUpdate.after_action_report}
										class="textarea textarea-bordered"
									></textarea>
								</div>
								<div class="mt-4">
